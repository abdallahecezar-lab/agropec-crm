...
const config: Config = {
  ...
  safelist: [
    ...
    'bg-blue-300', 'bg-cyan-300', 'bg-yellow-300', 'bg-orange-300', 'bg-purple-300',
    'bg-sky-300', 'bg-green-400', 'bg-rose-300', 'bg-red-300', 'bg-slate-300',
    // Cores de fundo das colunas
    'bg-blue-100', 'bg-cyan-100', 'bg-yellow-100', 'bg-orange-100', 'bg-purple-100',
    'bg-sky-100', 'bg-green-100', 'bg-rose-100', 'bg-red-100', 'bg-slate-100',
    // Bordas das colunas
    'border-blue-300', 'border-cyan-300', 'border-yellow-300', 'border-orange-300', 'border-purple-300',
